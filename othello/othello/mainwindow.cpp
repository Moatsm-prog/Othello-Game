...
void MainWindow::trigger_animation(){
    ...
    if (cur_val < max_val){
        ...
        icon.addPixmap(QPixmap(":/icons48x48/recourses/icons/48x48/minimize_ico.png"), QIcon::Normal,QIcon::Off);
    }else{
        end_val = min_val;
        ...
        icon.addPixmap(QPixmap(":/icons48x48/recourses/icons/48x48/dots_ico.png"), QIcon::Normal,QIcon::Off);
    }
